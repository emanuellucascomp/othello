...
public class GameView {
    ...
    private BorderPane waitingPane;
    ...
    private void createGivenUpPane() {
        ...
        Image image;
        try {
            image = new Image(getClass().getResource("/br/com/ppd/images/give_up.jpg").toURI().toString());
    ...
    private void createDefeatPane() {
        ...
        Image image;
        try {
            image = new Image(getClass().getResource("/br/com/ppd/images/game_over.jpg").toURI().toString());
            ImageView imageView = new ImageView(image);
    ...
    private void createVictoryPane() {
        ...
        Image image;
        try {
            image = new Image(getClass().getResource("/br/com/ppd/images/victory.jpg").toURI().toString());
            ImageView imageView = new ImageView(image);
    ...
    public BorderPane createWaitingPane() {
        ...
        Label label = new Label("Waiting player 2...");
    ...
    public void createGameScene() {
        ...
        gameScene.getStylesheets().add("/br/com/ppd/styles/gameStyle.css");
